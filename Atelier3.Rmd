...
```{r}
pie(table(viande.h),main= 'Consommation chez les hommes')
pie(table(viande.f),main= 'Consommation chez les femmes')
```

Consommation de chocolat entre les hommes et les femmes
...
Consommation de poisson selon le poids
...
Consommation du poisson entre les hommes et les  femmes 
...
```{r}
pie(table(poisson.h),main= 'Consommation chez les hommes')
pie(table(poisson.f),main= 'Consommation chez les femmes')
```

Consommation du poisson selon la taille
